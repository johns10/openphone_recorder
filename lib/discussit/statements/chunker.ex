defmodule Discussit.Statements.Chunker do
  @behaviour Discussit.Statements.Chunker.Behaviour
  ...
  defp impl(:temporal), do: Discussit.Statements.Chunker.Temporal
  defp impl(:test), do: Discussit.Statements.Chunker.Test
end
